...
def index():
    ...
    if request.method == 'POST':
        if request.form['btn_identifier'] == 'look':
            ...
            so = stat_dict['strikeOuts']
            RBI = stat_dict['rbi']
            return render_template('index.html', name=fullname, gamePlay=gamesPlayed, AVG=batAvg, homeRun=hr, SO=so,
                                   rbi=RBI)
    return render_template('index.html', name=fullname, gamePlay=gamesPlayed, AVG=batAvg, homeRun=hr, SO=so,
                           rbi=RBI)  # return a string
...
def standings():
    ...
    gb5 = team5['gb']
    return render_template('standings.html', data="<h1> American League East </h1>", error=error, name1=name1, w1=w1,
                           l1=l1, p1=p1, gb1=gb1, name2=name2, w2=w2, l2=l2, p2=p2, gb2=gb2, name3=name3, w3=w3, l3=l3,
                           p3=p3, gb3=gb3, name4=name4, w4=w4, l4=l4, p4=p4, gb4=gb4, name5=name5, w5=w5, l5=l5, p5=p5,
                           gb5=gb5)
